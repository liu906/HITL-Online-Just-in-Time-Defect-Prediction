  ...
  if(P<0 || N<0){
    dump_path <-
      paste(
        ...
        '_',
        temp,
        '_',evaluation_method,'_seed',seed,'_5Fold_FF0.99_dumpFile.csv',
        sep = ''
      )
    ...
    detail_path <-
      paste(
        ...
        '_',
        temp,
        '_',evaluation_method,'_seed',seed,'_5Fold_FF0.99_detail.csv',
        sep = ''
      )
    ...
    dump_path <-
      paste(
        ...
        '_',
        temp,
        '_',evaluation_method,'_',as.character(P/seconds_in_a_day),'_',as.character(N/seconds_in_a_day),'_seed',seed,'_5Fold_FF0.99_dumpFile.csv',
        sep = ''
      )
    dump_path <- file.path(root,dump_path)
    ...
    detail_path <-
      paste(
        ...
        '_',
        temp,
        '_',evaluation_method,'_',as.character(P/seconds_in_a_day),'_',as.character(N/seconds_in_a_day),'_seed',seed,'_5Fold_FF0.99_detail.csv',
        sep = ''
      )
    detail_path <- file.path(root,detail_path)
  }
